...
def experiment(base_index=0, start_index=0, build_base=True, path_base='base_cnn/', path_fisher='fisher.npy'):
    global attacks
    global normals
    ...
    if build_base:
        ...
        inst = Task_Nerwork(penalty=0.001, conv2d_filters=[8, 16],
    ...
    for i in range(start_index, len(attacks)):
        ...
        acc_prev, acc_new = inst.add_flows(new_flows, new_labels, validation_flows, validation_labels, new_test_flows,
                                           ...
                                           path='../../Results/results-cnn-stepwise2018/exp' + str(base_index) + str(i) + '.txt')
