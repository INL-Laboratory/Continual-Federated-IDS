...
def experiment(base_index=0):
    ...
    for i in range(11): # 11 attacks of the cic 2017 dataset
      ...
      acc_prev, acc_new = inst.add_flows(new_flows, new_labels, validation_flows, validation_labels, new_test_flows,
                                         ...
                                         path='../../Results/results-cnn-pair/exp' + str(base_index) + str(i) + '.txt')
