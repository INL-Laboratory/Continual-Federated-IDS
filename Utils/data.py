...
# this file has been written to access the cic-ids 2017 dataset located on our local server
...
if socket.gethostname() != 'HomeX':
    ...
    path = '/mnt/inl-backup/bkp-Home/home-old/soltani/2017-vectorize/'  # 2017
#    path = '/mnt/INL-Backup/bkp-Home/home-old/soltani/2017-vectorize/'  # 2017
                    ...
                    if number_of_attacks != 0:
                        if self.mode == 'binary':
                            size_of_each_benign = int(
                                (number_of_attack_samples - number_of_benign_samples) / (len(indexes_of_benigns) - (i + 1)))
                        else:
                            size_of_each_benign = int(
                                (actual_size_of_benign - number_of_benign_samples) / (len(indexes_of_benigns) - (i + 1)))
                    else:
                        size_of_each_benign = int(
